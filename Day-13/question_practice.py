...
name_list = ['Harsh', 'Logia', 'XYS', 'Drilbur']
age_list = [18, 734, 34, 23]
...
while game_on:
    user_choice = input("[Rock/Paper/Scissor/quit]: ").lower()
    bot_choice = rnd.choice(game_list)
    
    if user_choice == 'rock' and bot_choice == 'paper':
        print(f"Bot: {bot_choice.title()}, You: {user_choice.title()}\nYou lost.")
        ...
        print("Please choose correctly from [rock/paper/scissor].")
